...
if (seguir1==2)
{
System.out.println("If you want that the matrix be symmetric skip this step: enter 0 in the next two entries");
	int bueno1, bueno2;
...
*/
	...
	extension="_no_square.txt";
	 ...
	 bw.write(" ");
	    ...
	    {
	        boolean bq;
	        System.out.println("What matrix do you wnat to load");
	         if (!ruta.exists()) {
