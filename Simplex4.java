...
static  float solucion[][]=new float[260][10];
...
correcto[porque][B]=true;
 ...
 /* AQUI HAY QUE HALLAR EL MÍNIMO DE LAS MATRICES SOLUCIONES*/
           ...
           /*System.out.println("¿Quiere ver el minimo total (1) ó el parcial (otro) ?");
           Scanner tecla=new Scanner(System.in);
           Examen= tecla.nextInt();
           AQUÍ, SE IMPLEMENTA EL IF...THEN...ELSE...PARA LA DESVIACIÓN A LA CLASE MINIMOS.
           */
           
            presionaenter();
            limpieza();
             int luis, antonio,federo;
             String Don="          ";
           String solucionado="";
        ...
        System.out.println("TENEMOS QUE:");
         System.out.println("");
                for(federo=0;federo<rango1;federo++)
        {
           hola=minimo.min(solucion,correcto,combinatoria,rango1,federo);
              
               System.out.println("La variable de indice: "+federo+" tiene solución: "+hola);
           }
        /*}
        else
         ...
         System.out.println("Esto no está perfeccionado:");
        System.out.println("TENEMOS QUE LAS SOLUCIONES PUEDEN SER OTRAS...CON UN MAYOR VALOR");
         System.out.println("EL CÁLCULO DEL MÍNIMO NO HA TENIDO EN CUENTA EL ACOPLE DE LAS SOLUCIONES DEFINIDAS EN CADA COMBINACIÓN");
          /* for(federo=0;federo<rango1;federo++)
           {
               hola= Minimos.minimal(solucion,correcto,combinatoria,rango1,rango2,coste,federo);
               System.out.println("La variable: "+federo+" tiene solución: "+hola);
           }
        /*}*/
...
class minimo
{
    ...
    public static float min(float solucion[][], boolean correcto[][],int combinatoria,int rango1,int i)
    {
...
class Minimos
{
    // instance variables - replace the example below with your own
  static float solution[]=new float[10];
   public static void  minimal(float solucion[][], boolean correcto[][],int combinatoria,int rango1,int rango2, float coste[])
    {
       System.out.println("Hola,hay que minimizar la función de los costes");
