...
public class Dentera2 {
	...
	public static void Recuperar(boolean positivo) {
		int numero=1;
...
for(int i = 0; i < number1; i ++) {
    ...
    myCanvas.setForegroundColor(Color.black);
		...
		myCanvas.drawString("Determinante= "+gas,325,100);
...
System.out.println("Este programa calcula matrices cuya SUMA MAYOR DE LA ADJUNTA=DETERMINANTE");
System.out.println("Es decir, si e=(1,1,...,1), entonces (e-traspuesto)*ADJUNTA*e=det(A)");
	       ...
	       int fin=sc.nextInt();
	        ...
	        int matrices=0;
System.out.println("Con esa condicion... Posiblemente halla que buscar entre cientos de matrices! PACIENCIA");
System.out.print("Calculando la posible matriz que lo cumple de dimension "+number1+" entre la matriz numero : 0, ");
	        while(gatos==true)
	        {
	        try{
	        Entrada.CreaMatriz(dimensionx);
	    }catch(IOException e){
	        e.printStackTrace();
	    }
positivo=true;
...
/*OtroPaso.Limpieza();
 System.out.println("El determinante total es: " + det);
	...
	/*System.out.println("Sabiendo que el rango es: "+r);
	System.out.println("Podemos calcular el determinante por medio de menores");
	System.out.println("Introduzca el rango de los menores");
...
int determinantep=0;
int determinantep1=0;
int determinantef=0;
int determinantef1=0;
int determinantea=0;
int determinantea1=0;
int determinanteb=0;
int determinanteb1=0;
...
*/
if ((determinantep1==gil)||(determinanteb1==gil)||(determinantef1==gil)||(determinantea1==gil)||(determinanteb==gil)||(determinantea==gil)||(determinantep==gil)||(determinantef==gil))

{
System.out.println(" ");
if(determinantep==gil)
{
System.out.println("Exito!");
}
	gatos=false;
	System.out.println("El determinante era: "+gil);
/*System.out.println("El determinante m es: "+determinantem1);
/*System.out.println("Y, dividido es:"+determinantem1/determinantef);*/
System.out.println("Suma de los menores con signo,es: "+determinantep);
System.out.println("Suma de los menores con signo, negativo, es: "+determinantep1);
System.out.println(" suma de los valores absolutos de los menores, es: "+determinanteb);
System.out.println(" suma alternada de los menores, negativo, es: "+determinantea1);
System.out.println(" suma de los valores absolutos de los menores,negativo, es: "+determinanteb1);
System.out.println(" suma alternada de los menores, es: "+determinantea);
System.out.println(" suma de menores sin signo, es: "+determinantef);
System.out.println(" suma de menores sin signo,negativo, es: "+determinantef1);
System.out.println("Coincide! la siguiente matriz:");
positivo=false;
Recuperar(positivo);
}else 
{
...
System.out.println(" ");
System.out.println("¿Quiere grabar la matriz (1-si, otro numero-no)?");
System.out.println(" ");
...
System.out.println("Fin, pulsa CTRL+C");
...
return cuadrada;
	...
	public static void CreaMatriz(int dimensionx) throws IOException {
