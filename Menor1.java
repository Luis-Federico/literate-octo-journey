...
/* fin bloque 3*/
   ...
   /*   rango1=rango1-1; */
         ...
         while(rango1>=2)
         {
        System.out.println("Rango menores?");
	rango1=sc.nextInt();
if ((rango1<2)||(rango1>number1))
{
...
else
{
 ...
 Hola=Combinaciones*Combinaciones;
        System.out.println ("Hay "+ Hola+" menores ");  System.out.println("Esta seguro?,1-si, otro numero-no");                                        teclo=sc.nextInt();                             if(teclo==1)                                    {   
...
{
	System.out.println("Esta bien, otra vez");
}
...
for (int j=0;j<c2;j++)
{
System.out.print(df.format(mat2[i][j])+" ");
}
System.out.println(" ");
}
}
