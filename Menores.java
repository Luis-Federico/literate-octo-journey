...
System.out.println(" ");
System.out.println(" ");
      System.out.println(" QUIERE SABER EL RANGO O/y LA INVERSA?");
System.out.println("Pulse 1-SI RANGO, 2-RANGO E INVERSA, pulse otro NUMERO-NO");
     ...
     if(det!=0)
        { 
            ...
            System.out.println("El rango es: " + rango1);
              System.out.println("Inversa? si-2,no-otro numero");
if (teclo!=2){
                  teclo= sc.nextInt();  
}  
                  if (teclo==2)
...
/* fin del hacer mientras rango1>2 */
 ...
 /* fin de la condicion gh que son los menores que la matriz principal */


}
/* fin de la condicion si quiere ver el rango */
}else{

 System.out.println("Vease el programa del simplex");
...
cuadrada=true;
 ...
 System.out.println("INTRODUCE EL NUMERO DE FILAS, max=10 ");
       
         number1= sc.nextInt();
 System.out.println("INTRODUCE EL NUMERO DE COLUMNAS, max=10 ");
         number2= sc.nextInt();
if (number1!=number2){
cuadrada=false;
}
...
System.out.println("Total: "+lista.length);
         ...
         System.out.println("Elija...escriba el numero del fichero");
