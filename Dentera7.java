...
System.out.println("El nuevo determinante, suma de menores con signo, es NOTA2: "+determinantep);
System.out.println("El nuevo determinante, suma de los valores absolutos de los menores, es: "+determinanteb);
System.out.println("El determinante, suma alternada de los menores, es: "+determinantea);
System.out.println("El nuevo determinante, suma de menores sin signo, es: "+determinantef);
...
int dependientes1=sc.nextInt();
			...
			guapa1[1]= (int)(Math.random()*number1+1);
				...
				for(sultan1=2;sultan1<=dependientes1;sultan1++)
				{
...
System.out.println("Numero de COLUMNAS dependientes?, maximo=dimension-1");
int dependientes2=sc.nextInt();
			...
			for(sultan2=2;sultan2<=dependientes2;sultan2++)
				{
	        ...
	        guapa2[sultan2]= (int)(Math.random()*number1+1);
	         ...
	         for(diez=1;diez<sultan2;diez++)
	         {
	         if (guapa2[diez]!=guapa2[sultan2])
	         {
				  contador1=contador1+1;
				  
			  }
		  }
		  if (contador1==sultan2-1)
		  {
			  dependiente=true;
		  }
			  }while(dependiente=false);
